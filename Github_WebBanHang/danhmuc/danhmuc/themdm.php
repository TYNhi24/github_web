...
<html>
<head>
	<title>4 GIRLS | Thêm danh mục</title>
	<meta charset="utf-8">
				...
				<div class="row sm-gutter grid-content">
					<div class="column l-2 me-0 s-0">
						...
						<h3 class="category-heading">
							<p style="text-align: center; margin-top:20px;">Thêm danh mục</p>
							</h3>
						...
						<!-- BÊN DƯỚI LÀ sản phẩm -->
		<div class="product-detail-decribe" style="text-align: center; margin-bottom:200px">
         ...
         <table>
				...
				<tr>
					<td></td> 
					<td style="text-align: center;"> <input type="submit" name="submit"  value="Thêm danh mục mới" ></td>
				</tr>
				</form>
			</table>
					</div>	

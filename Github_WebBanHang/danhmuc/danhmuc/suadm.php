		...
		<div class="container">
			<div class="grid wide">
				<div class="row sm-gutter grid-content">
					<div class="column l-2 me-0 s-0">
						<nav class="category">
							<h3 class="category-heading">
								<p style="text-align: center; margin-top:20px;">Sửa danh mục</p>
							</h3>
					...
					<div class="product-detail-decribe" style="text-align: center; margin-bottom:190px">
...
<div >
	...
	<tr><td style="text-align: center;">   <input type="submit" value="Sửa tên danh mục"></td>      </tr>
    </table>         
	</form>
	</div>
					</div>	

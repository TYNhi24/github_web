					...
					<div class="column l-2 me-0 s-0">
						<nav class="category">
							<h3 class="category-heading">
								<a style="text-align: center; margin-top:20px;" href="./thongkesp.php">Thống kê sản phẩm</a>
							</h3>
...
<!--bên dưới là sản phẩm-->
					...
					<div class="home-filter">
								<h2 style="background-color: white;">
									<a href="themsp.php" style="color: black; font-size: 22px;">
										Thêm sản phẩm
									</a>
									</h2>
						...
						<?php
							...
							<a class="home-product-item" href="../pages/sanpham.php?id= '.$row['id'].'">
								...
								<div class="home-product-item__price">
									<div class="">'.number_format($row['giasp'],3).'đ</div>
									 <div class="home-product-item__price-new"></div>
								</div>

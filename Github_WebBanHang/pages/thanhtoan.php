...
<html>
<head>
	<title>4 GIRLS| Thanh toán</title>
	<meta charset="utf-8">
...
<div style="text-align: center; margin-top:40px; margin-bottom:200px">
   ...
   <?php
      ...
      foreach ($_SESSION['cart'] as $key => $value){
            $sql = "INSERT INTO chitietdonhang(iddonhang, iduser, idsp, soluong) VALUES ($id,$_SESSION[id], $key, $value)";
